export const UTILITIES = [
  {
    color: "primary",
    icon: "medal",
    title: "Whitelist Pass",
    description:
      "Whitelist pass to the upcoming derivative and collab collections",
  },
  {
    color: "error",
    icon: "chart",
  ...
  },
  {
    color: "warning",
    icon: "cup",
    title: "Private Yacht Parties",
    description:
      "Holder pass to IRL events, private monk-themed cosplay & yacht parties",
  },
  {
    color: "warning",
    icon: "gift",
    title: "FREE NFT Airdrops",
    description:
      "Free exclusive NFT airdrops from the brand partnerships and upcoming collections",
  },
  {
    color: "primary",
    icon: "check",
    title: "Merchandise",
    description:
      "Free official brand merchandise, official branded monk costume (Worldwide Shipping)",
  },
  {
    color: "error",
    icon: "flag",
...
export const ROADMAPS = [
  { title: "Alpha Collection Launch" },
  { title: "MonkChains Collection launch" },
  { title: "Post-Mint Giveaway" },
  { title: "Starting An NFT Media Company" },
  ...
  { title: "Derivative & Collab Collections" },
];

export const TEAMS = [
  { name: "Matias", role: "Lead Artist" },
